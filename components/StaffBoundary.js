...
export default function StaffBoundary({children}){
 ...
 if(user?.must_change_password)return <main className="staffAccess"><h1>Change your temporary password</h1><p>This administrator account must set a private password before opening staff tools.</p><Link className="button primary" href="/staff-password">Change password</Link></main>;
