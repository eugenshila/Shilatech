...
import StaffBrandBackground from './StaffBrandBackground';
...
export default function EmployeeDashboard({user,children}){
 ...
 return <>
  ...
  <style jsx global>{`.employeeDashboard .functionCards a{display:flex;flex-direction:column;gap:9px;padding:18px;background:linear-gradient(135deg,#142210,#0b110a);border:1px solid #39512e;border-radius:10px;text-decoration:none;color:#83ce51;min-height:85px;box-sizing:border-box}.employeeDashboard .functionCards a span{display:block;font-size:12px;color:#c0cfb8;line-height:1.5}.employeeDashboard .functionCards a:hover{border-color:#83ce51;background:#192b12}.employeeDashboard .functionCards a:focus-visible{outline:3px solid #b6eb91;outline-offset:3px}@media(max-width:640px){.employeeDashboard .functionCards a{padding:12px}}`}</style>
