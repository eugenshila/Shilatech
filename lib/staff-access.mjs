...
export const staffPageLabels={'/payroll':'ERP & payroll','/staff':'Staff home','/admin':'Reports & administration','/operations':'Operations & staff','/warehouse':'Warehouse','/pos':'Sales counter','/staff-garage':'Garage jobs','/delivery':'Delivery','/approvals':'Requests & approvals'};
