const destinations={
 admin:['/staff','/admin','/operations','/warehouse','/delivery','/pos','/staff-garage','/approvals'],
 general_manager:['/staff','/admin','/operations','/warehouse','/delivery','/pos','/staff-garage','/approvals'],
...
export function staffPages(role){
 ...
 return allowed.length?[...new Set([...allowed,'/approvals'])]:[];
}
...
export const staffPageLabels={'/staff':'Staff home','/admin':'Reports & administration','/operations':'Operations & staff','/warehouse':'Warehouse','/pos':'Sales counter','/staff-garage':'Garage jobs','/delivery':'Delivery','/approvals':'Requests & approvals'};
