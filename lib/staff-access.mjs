const destinations={
 hr:['/my-hr'],
 admin:['/staff','/admin','/operations','/warehouse','/delivery','/pos','/staff-garage','/approvals','/payroll','/receivables'],
 general_manager:['/staff','/admin','/operations','/warehouse','/delivery','/pos','/staff-garage','/approvals','/payroll','/receivables'],
 garage_staff:['/staff-garage','/approvals'],
 warehouse_manager:['/warehouse','/approvals'],
 cashier:['/pos','/receivables'],
 warehouse_clerk:['/warehouse'],picker:['/warehouse'],packer:['/warehouse'],
 dispatch:['/warehouse','/delivery'],finance:['/receivables','/warehouse'],auditor:['/warehouse'],
...
export const staffPageLabels={'/receivables':'Sales & finance','/my-hr':'My HR','/payroll':'ERP & payroll','/staff':'Staff home','/admin':'Reports & administration','/operations':'Operations & staff','/warehouse':'Warehouse','/pos':'Sales counter','/staff-garage':'Garage jobs','/delivery':'Delivery','/approvals':'Requests & approvals'};
