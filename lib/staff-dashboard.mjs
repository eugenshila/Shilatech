...
export function employeeShortcuts(role,path){
 ...
 let cards=pages.filter(p=>p!==root&&p!=='/my-hr').map(p=>({href:p,label:staffPageLabels[p],detail:'Open department'}));
 if(role==='finance')cards=cards.filter(c=>c.href==='/payroll'||c.href==='/receivables');
 if(root!=='/my-hr'){
