...
const functions=[
 [/^Enable extended finance$/,'finance-setup','Enable extended finance'],[/^Supplier and statutory bills$/,'bills','Supplier & government bills'],[/^Employee salary payments$/,'salary-payments','Salary payments'],[/^Review payment liabilities$/,'bill-review','Review payment liabilities'],[/^Payment settlements$/,'settlements','Record outgoing payments'],[/^Liabilities and payment reports$/,'payable-reports','Payment reports'],[/^Sales targets and KPIs$/,'sales-kpis','Sales targets & KPIs'],[/^Finance audit trail$/,'finance-audit','Finance audit trail'],
